...
public class BuildVars {
    ...
    public static boolean LOGS_ENABLED = true;//false;
    public static boolean USE_CLOUD_STRINGS = true;
    public static boolean CHECK_UPDATES = true;
    public static int BUILD_VERSION = 2227;
    public static String BUILD_VERSION_STRING = "7.4.0";
    public static int APP_ID = 1018253;//4;
    public static String APP_HASH = "06f90fc58a6efc85ca7eff2e3a17b04f";//"014b35b6184100b085b0d0572f9b5103";
